...
const items = [
  ...
  { q:'Что получит родитель?',                           a:'После каждого занятия — короткий отчёт: что разобрали, что получилось, что повторить. В конце — полная карта навыков.' },
  ...
  { q:'Как оплатить?',                                   a:'Картой через ЮKassa (все карты РФ, СБП, ЮMoney) или Stripe (международные). После диагностики пришлём ссылку.' },
  ...
  return (
    <section className="kim-section kim-section--soft" id="faq">
      <div className="kim-container">
        ...
        <h2 className="kim-h2" style={{ marginBottom: 0 }}>Частые вопросы</h2>
